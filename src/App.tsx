...
useEffect(() => {
    ...
    // Using the official Dala widget loader
    script.src = "https://dala.gebeya.com/agents/830688f4-d422-4684-bdfa-274cd55080bc/widget.js"; 
    script.async = true;
    script.id = "dala-agent-script";
    
    // Setting your specific configuration
    script.setAttribute('data-agent-id', '830688f4-d422-4684-bdfa-274cd55080bc');
    script.setAttribute('data-primary-color', '#2E7D32');
    script.setAttribute('data-greeting', 'Welcome to Travel Ethiopia. How can I help?');

    document.body.appendChild(script);

    console.log("Selam Agent is officially loading...");

    return () => {
      const existingScript = document.getElementById("dala-agent-script");
      if (existingScript) {
